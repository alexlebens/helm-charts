...
![Version: 6.0.6](https://img.shields.io/badge/Version-6.0.6-informational?style=flat-square) ![AppVersion: v1.26.0](https://img.shields.io/badge/AppVersion-v1.26.0-informational?style=flat-square)
...
| backup.objectStore[0].endpointCA | object | `{"create":false,"key":null,"name":null}` | Specifies a CA bundle to validate a privately signed certificate. |
...
| recovery.objectStore.endpointCA | object | `{"create":false,"key":null,"name":null}` | Specifies a CA bundle to validate a privately signed certificate. |
