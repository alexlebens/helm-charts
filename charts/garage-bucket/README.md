...
| backups.primary.externalSecret | object | `{"accessKeyIdPath":"","accessKeyIdProperty":"ACCESS_KEY_ID","enabled":true,"secretAccessKeyPath":"","secretAccessKeyProperty":"ACCESS_SECRET_KEY","storeName":"openbao"}` | Using ExternalSecret to pull destination credentials from OpenBao/Vault |
...
| backups.secondary.externalSecret | object | `{"accessKeyIdPath":"","accessKeyIdProperty":"ACCESS_KEY_ID","enabled":true,"secretAccessKeyPath":"","secretAccessKeyProperty":"ACCESS_SECRET_KEY","storeName":"openbao"}` | Using ExternalSecret to pull destination credentials from OpenBao/Vault |
...
| externalSecret | object | `{"accessKeyIdPath":"","accessKeyIdProperty":"ACCESS_KEY_ID","enabled":true,"secretAccessKeyPath":"","secretAccessKeyProperty":"ACCESS_SECRET_KEY","storeName":"openbao"}` | Configuration for importing an existing key via ExternalSecret If disabled, Garage operator will auto-generate credentials. |
