...
| backups.primary.externalSecret | object | `{"accessKeyIdPath":"","accessKeyIdProperty":"ACCESS_KEY_ID","enabled":true,"secretAccessKeyPath":"","secretAccessKeyProperty":"ACCESS_SECRET_KEY","secretPath":"","secretPathPrefix":"","storeName":"openbao"}` | Using ExternalSecret to pull destination credentials from OpenBao/Vault |
...
| backups.primary.externalSecret.secretPathPrefix | string | `""` | Prefix for auto-generating secretPath as <prefix>/<bucketName> |
...
| backups.secondary.externalSecret | object | `{"accessKeyIdPath":"","accessKeyIdProperty":"ACCESS_KEY_ID","enabled":true,"secretAccessKeyPath":"","secretAccessKeyProperty":"ACCESS_SECRET_KEY","secretPath":"","secretPathPrefix":"","storeName":"openbao"}` | Using ExternalSecret to pull destination credentials from OpenBao/Vault |
...
| backups.secondary.externalSecret.secretPathPrefix | string | `""` | Prefix for auto-generating secretPath as <prefix>/<bucketName> |
...
| externalSecret | object | `{"accessKeyIdPath":"","accessKeyIdProperty":"ACCESS_KEY_ID","enabled":true,"secretAccessKeyPath":"","secretAccessKeyProperty":"ACCESS_SECRET_KEY","secretPath":"","secretPathPrefix":"","storeName":"openbao"}` | Configuration for importing an existing key via ExternalSecret If disabled, Garage operator will auto-generate credentials. |
...
| externalSecret.secretPathPrefix | string | `""` | Prefix for auto-generating secretPath as <prefix>/<bucketName> |
